...
import com.cornCar.jpaShop.domain.OrderStatus;
import com.cornCar.jpaShop.domain.item.Book;
import com.cornCar.jpaShop.domain.item.Item;
import com.cornCar.jpaShop.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        //then
        Order getOrder = orderRepository.findByUsername(orderId);
